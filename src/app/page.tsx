  ...
  return (
    ...
    <section className="mb-20 container mx-auto px-4 py-12">
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
				{wallets.map((wallet,index) => <Card key={`card-${index}`} {...wallet} />)}
			</div>
		</section>
    <section
			className="mt-8 pt-12 bg-white bg-[url('/plus.png')] w-full bg-repeat bg-top bg-[size:75px_75px] h-[640px] flex items-center justify-center"
		>
			<div
				className="max-w-2xl mx-auto px-6 py-4 bg-white flex flex-col items-center justify-center"
			>
				...
				<h3
					className="text-3xl font-semibold text-gray-400 mb-6 text-center"
				>
				...
				<div className="space-y-4 mb-8">
					<p className="text-sm text-neutral-600 max-w-xl text-center">
						If you have not already done so, please import your
						account to a new wallet using your recovery phrase. If
						you created an email or text message backup, your
						recovery link will still work but now defaults to <a
							href="https://app.mynearwallet.com"
							className="text-blue-500 hover:underline"
							target="_blank"
							rel="noopener noreferrer">app.mynearwallet.com</a
						>
					</p>

					<p className="text-sm text-neutral-600 max-w-xl text-center">
						If you think you have a recovery backup email but are
						not sure how to find it, search your email for &quot;Near
						Wallet Recovery&quot; in the subject line (include quotes for
						better results)
					</p>
				</div>
